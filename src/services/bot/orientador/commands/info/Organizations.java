 ...
 *
 */
public class Organizations implements CommandI {

	private static final String SELECT_ORG_COMMAND = "select-orgs";
	...
	public Organizations() {
		...
		options.add(new OptionData(OptionType.STRING, SELECT_ORG_COMMAND, "Escoje una organización", true)
	...
	public void execute(SlashCommandInteractionEvent event) {
		...
		OptionMapping programOption = event.getOption(SELECT_ORG_COMMAND);
