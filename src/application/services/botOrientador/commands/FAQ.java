...
public class FAQ implements CommandI {
	...
	public void execute(SlashCommandInteractionEvent event) {
		...
		embedBuider.addField(
			...
			""",
			"""
			Con los Bot-Developers o dejar
			""", true);
		
		embedBuider.addField(
			"""
			4) Me siento indeciso sobre mi departamento. ¿Con quién hablo?
			""",
			"""
		...
		embedBuider.addField(
			"""
			5) Tengo unas clases convalidadas por el CEEB ¿Con quién hablo?
			""",
			"""
		...
		embedBuider.addField(
			"""
			6) ¿A quién voy para conseguir mi curriculo?
			""",
			"""
		...
		embedBuider.addField(
			"""
			7) ¿Cómo consigo los comandos para el bot?
			""",
			"""
		...
		embedBuider.addField(
			"""
			8) ¿Cómo crearon el bot?
			""",
			"""
			El bot fue programado inicialmente por nuestros Ex-alumnos Fernando y Gabriel en Python. 
			Pero para esta nueva versión con la que estas interactuando está programado en Java!!
			Cualquier pregunta le pueden escribir a Alfredo o a cualquier Bot-Developer. Ellos te 
			pueden explicar y enseñar algunos detalles de como se hizo si estas interesad@!
			""", true);
		embedBuider.addField(
			"""
