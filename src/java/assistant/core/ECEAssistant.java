 ...
 * 
 */
package java.assistant.core;

import java.assistant.command.contacts.AcademicAdvisoryCmd;
import java.assistant.command.contacts.DCSPCmd;
import java.assistant.command.contacts.DeanOfStudentsCmd;
import java.assistant.command.contacts.DepartmentCmd;
import java.assistant.command.contacts.EconomicAssistanceCmd;
import java.assistant.command.contacts.UniversityGuardCmd;
import java.assistant.command.files.CurriculumCmd;
import java.assistant.command.files.FreshmanGuideCmd;
import java.assistant.command.information.CalendarCmd;
import java.assistant.command.information.EOInfoCmd;
import java.assistant.command.information.FAQCmd;
import java.assistant.command.information.FacultyCmd;
import java.assistant.command.information.FindBuildingCmd;
import java.assistant.command.information.HelpCmd;
import java.assistant.command.information.OrgsCmd;
import java.assistant.command.information.ProjectsCmd;
import java.assistant.command.information.RulesCmd;
import java.assistant.command.information.UprmMapCmd;
import java.assistant.command.links.LinksCmd;
import java.assistant.command.links.MadeWebCmd;
import java.assistant.command.moderation.AssistantCmd;
import java.service.discord.core.BotApplication;
import java.service.discord.core.ListenerAdapterManager;
